...
// استقبال دالة onNavigate لتمكين التنقل السري للأدمن
const Footer = ({ onNavigate }) => {
    return (
      <footer className="main-footer">
        ...
        {/* شريط الحقوق السفلي الممتد في المنتصف مع إضافة الزر السري */}
        <div className="footer-bottom-bar">
          <p>جميع الحقوق محفوظة © Medlink 2026</p>
          
          {/* الكلمة السرية: مدمجة بجانب الحقوق ومخفية بذكاء لفتح داشبورد الأدمن فوراً */}
          <span 
            onClick={() => onNavigate && onNavigate('admin-dashboard')} 
            style={{ 
              cursor: 'pointer', 
              color: '#fafafa', // لون قريب جداً من خلفية بار الحقوق حتى لا يلاحظه أحد سواكِ
              fontSize: '13px',
              userSelect: 'none',
              marginRight: '15px',
