...
const ClinicRequestDetails = ({
  ...
  const handleConfirmAccept = async () => {
    ...
    const endpoint = isPharmacy
      ? `https://medlink-s.apps.taqat.academy /api/admin/pharmacy-requests/${selectedRequest.id}/approve`
      : `https://medlink-s.apps.taqat.academy /api/admin/clinic-requests/${selectedRequest.id}/approve`;
  ...
  const handleConfirmReject = async () => {
    ...
    const endpoint = isPharmacy
      ? `https://medlink-s.apps.taqat.academy /api/admin/pharmacy-requests/${selectedRequest.id}/reject`
      : `https://medlink-s.apps.taqat.academy /api/admin/clinic-requests/${selectedRequest.id}/reject`;
