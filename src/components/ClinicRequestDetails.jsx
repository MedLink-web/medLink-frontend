...
const ClinicRequestDetails = ({
    ...
    return (
        ...
        <div className="details-navigation-header">
            ...
            <span className="current-sub-view">عرض تفاصيل {selectedRequest.name}</span>
        </div>

        {/* رسالة نجاح */}
        {successStatus && (
            <div className="success-banner-alert">
                ✅ تمت الموافقة على هذا الطلب وهو الآن نشط ومسجل رسمياً على منصة MedLink. تم إرسال بيانات الدخول على البريد الإلكتروني.
            </div>
        )}
        ...
        <div className="details-card-container">
            <div className="details-grid">
                <div className="details-row">
                    <span className="field-label">اسم {isPharmacy ? "الصيدلية" : "العيادة"} :</span>
                    <span className="field-value font-bold">{selectedRequest.name}</span>
                </div>
                <div className="details-row">
            ...
            <div className="modal-overlay">
                <div className="modal-box-card">
                    ...
                    <p className="modal-description-text">
                        بعد تأكيد القبول سيتم إنشاء حساب {isPharmacy ? "الصيدلية" : "العيادة"} تلقائياً
                        وإرسال بيانات الدخول على بريدهم الإلكتروني.
                    </p>
