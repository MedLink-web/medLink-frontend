...
const PharmacyRegisterForm = ({ onNavigate }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://127.0.0.1:8000/api/pharmacy-requests", {
                method: "POST",
        ...
        return (
            <div className="pharmacy-reg-container" dir="rtl"
                ...
                <div style={{
                    ...
                    boxShadow: "0 2px 8px rgba(0,0,0,0.1)", maxWidth: "480px"
                }}>
                    ...
                    <div style={{
                        ...
                        marginBottom: "24px", color: "#276749"
                    }}>
                ...
                <div className="form-wrapper">
                    ...
                    <form onSubmit={handleSubmit} className="actual-form">
                        ...
                        <div className="reg-input-group">
                            ...
                            <div className="input-with-icon-wrapper">
                                <input
                                    ...
                                    className="reg-custom-input" required
                                />
                        ...
                        <div className="reg-input-group">
                            ...
                            <div className="input-with-icon-wrapper">
                                <input
                                    type="text" name="pharmacyAddress"
