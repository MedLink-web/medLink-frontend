...
const DoctorsManagement = ({ onNavigate, onDelete, showToast }) => {
  ...
  const fetchDoctors = async () => {
    ...
    try {
      const response = await fetch(
        "https://medlink-s.apps.taqat.academy /api/clinic/doctors",
        {
          headers: {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(
        `https://medlink-s.apps.taqat.academy /api/clinic/doctors/${doctorToDelete.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${getToken()}`,
  ...
  const confirmEdit = async () => {
    ...
    try {
      const response = await fetch(
        `https://medlink-s.apps.taqat.academy /api/clinic/doctors/${doctorToEdit.id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${getToken()}`,
